...
router.route("/update-user-meal-recommendation/:Id").get(isAuthenticated("web"), authorizedRoles("dietitian"), userMealRecommendationUpdate);
router.route("/delete-user-meal-recommendation/:Id").delete(isAuthenticated("web"), authorizedRoles("dietitian"), userMealRecommendationDelete);
